...
PUBLIC_HEADERS:=volatile_page_store.h volatile_page_store_stats.h volatile_page_store_page_accessor.h
...
LFLAGS:=-L${LIB_DIR} -l${PROJECT_NAME} -lblockio -lserint -lboompar -lcutlery -lpthread
# Archiver
AR:=ar rcs
