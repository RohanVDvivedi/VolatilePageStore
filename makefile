# project name
PROJECT_NAME:=volatilepagestore
...
PUBLIC_HEADERS:=volatile_page_store.h volatile_page_store_stats.h volatile_page_store_page_accessor.h mmaped_file_pool_public.h
...
LFLAGS:=-L${LIB_DIR} -l${PROJECT_NAME} -lblockio -lboompar -lcutlery -lpthread
# Archiver
AR:=ar rcs
